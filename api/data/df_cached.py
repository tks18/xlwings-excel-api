...
@xw.func
def DF_GROUPBY(src_name: str, by, cols=None, funcs=None):
    """
...
def DF_ASSIGN(src_name: str, kwargs_in="{}"):
    try:
        ...
        return f"DF_ASSIGN error: {e}"


@xw.func
def DF_VALUE_COUNTS(src_name: str, kwargs_in="{}"):
    """
...
@xw.func
def DF_STATS(src_name: str, mode: str, kwargs_in="{}"):
...
@xw.func
def DF_TO_DATETIME(src_name: str, cols, mutate=True, fmt=None):
    """
    ...
    try:
        ...
        return f"DF_TO_DATETIME error: {e}"
